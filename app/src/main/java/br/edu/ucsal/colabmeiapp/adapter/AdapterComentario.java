...
public class AdapterComentario extends RecyclerView.Adapter<AdapterComentario.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            imagemPerfil = itemView.findViewById(R.id.imageViewFotoComentario);
            nomeUsuario = itemView.findViewById(R.id.textUsuarioComentario);
            comentario = itemView.findViewById(R.id.textComentarioAdapter);
        }
    }
